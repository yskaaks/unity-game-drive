...
public class IOSNativeSettingsEditor : Editor {
	...
	private static string IOSNativeMarketBridge_Path 		= ISN_SCRIPTS + "StoreKit/Controllers/IOSNativeMarketBridge.cs";
	private static string IOSStoreProductView_Path 			= ISN_SCRIPTS + "StoreKit/Models/IOSStoreProductView.cs";
	...
	private void EditorTesting() {
		...
		IOSNativeSettings.Instance.IsEditorTestingEnabled = SA.Common.Editor.Tools.ToggleFiled("Editor Testing", IOSNativeSettings.Instance.IsEditorTestingEnabled);
	...
	public static void APISettings() {
		...
		if(IOSNativeSettings.Instance.ExpandAPISettings) {
			...
			IOSNativeSettings.Instance.EnableContactsAPI = EditorGUILayout.Toggle("Contacts API",  IOSNativeSettings.Instance.EnableContactsAPI);
			EditorGUILayout.EndHorizontal();
	...
	public static void CameraAndGallery(bool showTitle = true) {
		...
		IOSNativeSettings.Instance.PhotoLibraryUsageDescription	 	= EditorGUILayout.TextField(IOSNativeSettings.Instance.PhotoLibraryUsageDescription);
		EditorGUILayout.EndHorizontal();

		EditorGUILayout.BeginHorizontal();
		EditorGUILayout.LabelField("Camera Usage Description");
		IOSNativeSettings.Instance.CameraUsageDescription	 	= EditorGUILayout.TextField(IOSNativeSettings.Instance.CameraUsageDescription);
		EditorGUILayout.EndHorizontal();


		GUI.enabled = IOSNativeSettings.Instance.EnableMediaPlayerAPI;

		EditorGUILayout.BeginHorizontal();
		EditorGUILayout.LabelField("Apple Music Usage Description");
		IOSNativeSettings.Instance.AppleMusicUsageDescription	 	= EditorGUILayout.TextField(IOSNativeSettings.Instance.AppleMusicUsageDescription);
		EditorGUILayout.EndHorizontal();



		GUI.enabled = IOSNativeSettings.Instance.EnableContactsAPI;

		EditorGUILayout.BeginHorizontal();
		EditorGUILayout.LabelField("Contacts Usage Description");
		IOSNativeSettings.Instance.ContactsUsageDescription	 	= EditorGUILayout.TextField(IOSNativeSettings.Instance.ContactsUsageDescription);
		EditorGUILayout.EndHorizontal();
	...
	public static void ThirdPartySettings(bool showTitle = true) {
		...
		EditorGUI.indentLevel++; {
			...
			IOSNativeSettings.Instance.OneSignalEnabled = SA.Common.Editor.Tools.ToggleFiled("Enable One Signal", IOSNativeSettings.Instance.OneSignalEnabled);
			if(EditorGUI.EndChangeCheck())  {
		...
		EditorGUI.indentLevel++; {
			...
			IOSNativeSettings.Instance.EnableSoomla = SA.Common.Editor.Tools.ToggleFiled("Enable GROW", IOSNativeSettings.Instance.EnableSoomla);
			if(EditorGUI.EndChangeCheck())  {
				UpdatePluginSettings();
			}
	...
	public static void UpdatePluginSettings() {
		...
		SA.Common.Editor.Tools.ChnageDefineState(ISN_RemoteNotificationsController_Path, 		"PUSH_ENABLED", IOSNativeSettings.Instance.EnablePushNotificationsAPI);
		
		
		SA.Common.Editor.Tools.ChnageDefineState(GameCenterManager_Path, 				"GAME_CENTER_ENABLED", IOSNativeSettings.Instance.EnableGameCenterAPI);
		SA.Common.Editor.Tools.ChnageDefineState(GameCenter_TBM_Path, 					"GAME_CENTER_ENABLED", IOSNativeSettings.Instance.EnableGameCenterAPI);
		SA.Common.Editor.Tools.ChnageDefineState(GameCenter_RTM_Path, 					"GAME_CENTER_ENABLED", IOSNativeSettings.Instance.EnableGameCenterAPI);
		SA.Common.Editor.Tools.ChnageDefineState(ISN_GameSaves_Path, 					"GAME_CENTER_ENABLED", IOSNativeSettings.Instance.EnableGameCenterAPI);


		
		SA.Common.Editor.Tools.ChnageDefineState(IOSNativeMarketBridge_Path, 			"INAPP_API_ENABLED", IOSNativeSettings.Instance.EnableInAppsAPI);
		SA.Common.Editor.Tools.ChnageDefineState(IOSStoreProductView_Path, 			"INAPP_API_ENABLED", IOSNativeSettings.Instance.EnableInAppsAPI);
		SA.Common.Editor.Tools.ChnageDefineState(ISN_Security_Path, 					"INAPP_API_ENABLED", IOSNativeSettings.Instance.EnableInAppsAPI);

		
		SA.Common.Editor.Tools.ChnageDefineState(IOSSocialManager_Path, 				"SOCIAL_API", IOSNativeSettings.Instance.EnableSocialSharingAPI);
		
		SA.Common.Editor.Tools.ChnageDefineState(IOSCamera_Path, 						"CAMERA_API", IOSNativeSettings.Instance.EnableCameraAPI);
		SA.Common.Editor.Tools.ChnageDefineState(ISN_FilePicker_Path, 					"PICKER_API", IOSNativeSettings.Instance.EnablePickerAPI);
		
		SA.Common.Editor.Tools.ChnageDefineState(IOSVideoManager_Path, 				"VIDEO_API", IOSNativeSettings.Instance.EnableMediaPlayerAPI);
		SA.Common.Editor.Tools.ChnageDefineState(ISN_MediaController_Path, 			"VIDEO_API", IOSNativeSettings.Instance.EnableMediaPlayerAPI);
		
		SA.Common.Editor.Tools.ChnageDefineState(ISN_ReplayKit_Path, 					"REPLAY_KIT", IOSNativeSettings.Instance.EnableReplayKit);
		SA.Common.Editor.Tools.ChnageDefineState(ISN_CloudKit_Path, 					"CLOUD_KIT", IOSNativeSettings.Instance.EnableCloudKit);


		SA.Common.Editor.Tools.ChnageDefineState(ISN_GestureRecognizer_Path, 			"GESTURE_API", IOSNativeSettings.Instance.EnableGestureAPI);
		SA.Common.Editor.Tools.ChnageDefineState(ISN_ContactStore_Path, 			"CONTACTS_API_ENABLED", IOSNativeSettings.Instance.EnableContactsAPI);
		...
		if(!IOSNativeSettings.Instance.EnableSoomla) {
			SA.Common.Editor.Tools.ChnageDefineState(ISN_Soomla_Path, 						"SOOMLA", IOSNativeSettings.Instance.EnableSoomla);
