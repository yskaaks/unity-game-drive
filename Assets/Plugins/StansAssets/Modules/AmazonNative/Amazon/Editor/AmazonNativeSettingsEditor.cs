...
public class AmazonNativeSettingsEditor : Editor {
	...
	private static string SA_AmazonGameCircleManager_Path = "Extensions/AmazonNative/Amazon/Manage/SA_AmazonGameCircleManager.cs";
	private static string GC_Achievement_Path			  = "Extensions/AmazonNative/Amazon/Models/GC_Achievement.cs";
	private static string GC_Leaderboard_Path             = "Extensions/AmazonNative/Amazon/Models/GC_Leaderboard.cs";
	private static string GC_Player_Path				  = "Extensions/AmazonNative/Amazon/Models/GC_Player.cs";
	private static string GC_ScoreTimeSpan_Path 		  = "Extensions/AmazonNative/Amazon/Enums/GC_ScoreTimeSpan.cs";

	private static string SA_AmazonAdsManager_Path = "Extensions/AmazonNative/Amazon/Manage/SA_AmazonAdsManager.cs";

	private static string SA_AmazonBillingManager_Path 					 = "Extensions/AmazonNative/Amazon/Manage/SA_AmazonBillingManager.cs";
	private static string Billing_GetUserDataResponse_Path 				 = "Extensions/AmazonNative/Amazon/Responces/Billing/AMN_GetUserDataResponse.cs";
	private static string Billing_PurchaseResponse_Path 				 = "Extensions/AmazonNative/Amazon/Responces/Billing/AMN_PurchaseResponse.cs";
	private static string Billing_GetProductDataResponse_Path 			 = "Extensions/AmazonNative/Amazon/Responces/Billing/AMN_GetProductDataResponse.cs";
	private static string Billing_GetPurchaseProductsUpdateResponse_Path = "Extensions/AmazonNative/Amazon/Responces/Billing/AMN_GetPurchaseProductsUpdateResponse.cs";
	private static string Billing_AmazonProductTemplate_Path 		 	 = "Extensions/AmazonNative/Amazon/Models/AmazonProductTemplate.cs";
	private static string Billing_AmazonReceipt_Path 		 	 		 = "Extensions/AmazonNative/Amazon/Models/SA_AmazonReceipt.cs";
